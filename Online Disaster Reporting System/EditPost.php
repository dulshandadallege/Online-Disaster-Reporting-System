...
<ul>
   ...
   ?>
            ...
            <a href="manager.php"><button type="button" class="btn btn-info btn-sm">Back to the Previous Page</button></a>

            <?php
            
            $message2 = '<div class="my-notify-success"><h1 align="center">You have successfully updated a report</h1></div>';
            $message3 = '<div class="my-notify-success"><h1 align="center">You have successfully approved a new report</h1></div>';
            $message4 = '<div class="my-notify-success"><h1 align="center">You have successfully deleted a new report</h1></div>';
