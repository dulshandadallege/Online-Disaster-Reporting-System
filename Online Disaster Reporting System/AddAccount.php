...
<ul>
   ...
   <?php
     ...
     ?>
            ...
            $message1 = '<div class="my-notify-success"><h1 align="center">You have successfully created a new user</h1></div>';
...
if (isset($_POST['add']))
{
    ...
    if(isset($_POST['add']))
    {
        ...
        else
        {
            ...
            $query= "INSERT INTO `users`( `fName`, `lName`, `NIC`, `TelNo`, `privilege`, `email`, `address1`, `address2`, `address3`, `dob`, `password`, `is_approved`) VALUES ('$fname','$lname','$nic','$tno','$privilege','$email','$add1','$add2','$add3','$dob', md5('$pwd'),'$approval');";
